...
Then The photo of the house with ID "house_id" is updated successfully
...
Then The location of the house with ID "house_id" is updated successfully
...
Then The available services of the house with ID "house_id" are updated successfully
...
Then The monthly rent of the house with ID "house_id" is updated successfully
...
@tag 
Scenario: User enters an invalid house ID
  Given There are existing houses in the system
  And The owner wants to update the photo of a house
  When The owner enters an invalid house ID "invalid_id"
  Then The system displays an error message "Invalid house ID"
